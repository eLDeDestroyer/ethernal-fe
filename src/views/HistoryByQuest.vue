<template>
  <div class="min-h-screen bg-linear-to-b from-blue-50 to-blue-100 p-4">
    ...
    <div class="flex items-center mb-4 lg:mb-10 mt-14">
      <div
        class="w-10 h-10 lg:w-14 lg:h-14 bg-blue-600 text-white rounded-xl flex items-center justify-center text-lg font-bold lg:text-[1.8rem]"
      >
        📝
      </div>
    ...
    >
      ...
      >
        <!-- DATE AS TITLE -->
        <h3
          class="text-base lg:text-lg font-bold text-gray-900 leading-snug mb-2"
        >
    ...
    <div
      v-if="!isLoading && res.data.history.length === 0"
